...
class CourseViewMenuComponent(BaseComponent):
    def __init__(self, page: Page):
        ...
        self.edit_menu_button = page.get_by_test_id('course-view-edit-menu-button')
        self.delete_menu_button = page.get_by_test_id('course-view-delete-menu-button')
    ...
    def click_delete(self, index: int):
        ...
        expect(self.delete_edit_menu_button.nth(index)).to_be_visible()
