...
class ImageUploadWidgetComponent(BaseComponent):
    def __init__(self, page: Page, identifier: str):
        ...
        self.info_icon = Icon(page, f'{identifier}-image-upload-widget-info-icon', 'Info icon')
        self.info_title = Text(page, f'{identifier}-image-upload-widget-info-title-text', 'Info title')
        self.info_description = Text(page, f'{identifier}-image-upload-widget-info-description-text', 'Info description')
