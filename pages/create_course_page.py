...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        self.preview_empty_view_description = page.get_by_test_id('create-course-preview-empty-view-idescription-text')
        
        self.preview_image_upload_icon = page.get_by_test_id('create-course-preview-image-upload-widget-preview-info-icon')
        self.preview_image_upload_title = page.get_by_test_id('create-course-preview-image-upload-widget-preview-info-title-text')
        self.preview_image_upload_description = page.get_by_test_id('create-course-preview-image-upload-widget-preview-description-text')
        ...
        self.create-course_title_input = page.get_by_test_id('create-course-form-title-input').locator('input')
        self.create-course_estimated_time_input = page.get_by_test_id('create-course-form-estimated-time-input').locator('input')
        self.create-course_description_textarea = page.get_by_test_id('create-course-form-description-input').locator('textarea').first
        self.create-course_title_input = page.get_by_test_id('create-course-form-title-input').locator('input')
        
        self.create-course_max_score_input = page.get_by_test_id('create-course-form-max_score-input').locator('input')
        self.create-course_min_score_input = page.get_by_test_id('create-course-form-min_score-input').locator('input')
        
        self.exercises_title = page.get_by_test_id('create-course-exercises-box-toolbar-title-text')
        self.create_exercises_button = page.get_by_test_id('create-course-exercises-box-toolbar-create-exercises-button')
        ...
        self.exercises_empty_view_description = page.get_by_test_id('create-course-exercises-empty-description-text')
        ...
        def check_visible_image_upload_view(self, is_image_uploaded: bool = False):
            ...
            def check_visible_preview_imqge(self):
            ...
            def fill_create_course_form(
                ...
                self.create_course_min_score_input.fill(max_score)
                expect(self.create_course_min_score_input).to_have_value(min_score)
            ...
            def check_visible_create_exercise_title(self):
                expect(self.create_exercise_title).to_be_visible()
                
            def click_create_exercise_button(self):
                self.reate_exercise_button.click()
            ...
            def check_visible_create_exercise_form(self, index: int, title: str, description: str, ):
                exercise_subtitle = self.page.get_by_test_id(
                    f'create-course-exercise-{index}-box-toolbar-subtilte-text'
                )
